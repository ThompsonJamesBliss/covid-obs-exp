...
- `observationDay`: date of observation.
- `team`: NFL team.
- `testedToday`: binary variable for whether the given team tested on the given day (based on whether it was a game day during the first four weeks of the season).
